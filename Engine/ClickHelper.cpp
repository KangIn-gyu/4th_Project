...
Object* ClickHelper::FindObj(DXMath::Vector3 _rayOrigin, DXMath::Vector3 _rayDirection)
{
...
void ClickHelper::checkClickobj(int _mouseX, int mouseY)
{
	...
	std::cout << _mouseX << " " << mouseY <<  std::endl;
	DXMath::Ray ray = GenerateRayFromMouse(_mouseX, mouseY, screenWidth, screenHeight, CameraObject::g_MainCameraObject->GetViewMatrix()
