...
Texture2D ShininessColor      : register(t6);  // Shininess (aiTextureType_SHININESS)
...
Texture2D BaseColorMap        : register(t11); // Base Color (aiTextureType_BASE_COLOR)
...
Texture2D MetalnessMap        : register(t14); // Metalness (aiTextureType_METALNESS)
