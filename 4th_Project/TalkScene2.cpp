...
TalkScene2::TalkScene2(std::string_view _Name) : Scene(_Name)
{
    // Font/DialogScene.ttf  // GyeonggiMillenniumBackground_Regular
    dialog = CreatorObject<D2DBaseObj>("TalkScene2", Object::ObjectType::UI,
...
void TalkScene2::Update(const float _deltaTime)
{
...
void TalkScene2::ResetInformation()
{
