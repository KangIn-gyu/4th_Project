...
TalkScene4::TalkScene4(std::string_view _Name) : Scene(_Name)
{
    // Font/DialogScene.ttf  // GyeonggiMillenniumBackground_Regular
    dialog = CreatorObject<D2DBaseObj>("TalkScene4", Object::ObjectType::UI,
...
void TalkScene4::Update(const float _deltaTime)
{
...
void TalkScene4::ResetInformation()
{
