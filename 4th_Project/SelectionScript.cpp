...
void SelectionScript::ComponentSetting()
{
...
void SelectionScript::Update(const float _deltaTime)
{
...
void SelectionScript::ResetInformation()
{
	index = 0;
	displayedText = L"";
...
void SelectionScript::OnInputProcess(const DX::Keyboard::State& _KeyState, const DX::Keyboard::KeyboardStateTracker& _KeyTracker, const DX::Mouse::State& _MouseState, const DX::Mouse::ButtonStateTracker& _MouseTracker)
{
