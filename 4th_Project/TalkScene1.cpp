...
TalkScene1::TalkScene1(std::string_view _Name) : Scene(_Name)
{
    // Font/DialogScene.ttf  // GyeonggiMillenniumBackground_Regular
    dialog = CreatorObject<D2DBaseObj>("TalkScene1", Object::ObjectType::UI,
...
void TalkScene1::Update(const float _deltaTime)
{
...
void TalkScene1::ResetInformation()
{
